...
if ( isset ( $_SESSION [ 'id' ] ))
{
      ...
      */
      ...
      if(empty($errors)==true)
      {
        ...
        if(isset($_POST['nama_project']))
        {
            ...
            $insertQuery = " INSERT INTO tb_file  (nama_project , file ) VALUES ('$nama_project', '$nama_file')  "; 
   ...
   $selectQuery = "SELECT * FROM tb_file";
...
<body>
    ...
    <div class="container">
          <h2 class="mt-4">PT Pindad (Persero)</h2>
            <div class="body">
                                ...
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="label bg-green">1 January 2018</span></td>
                                            <td>    
                                            ...
                                            <td>
                                                <div class="progress">
                                                    <div class="progress-bar bg-green" role="progressbar" aria-valuenow="62" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
