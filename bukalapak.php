...
if ( isset ( $_SESSION [ 'id' ] ))
{
      ...
      */
      ...
      if(empty($errors)==true)
      {
        ...
        if(isset($_POST['nama_project']))
        {
            ...
            $insertQuery = " INSERT INTO tb_file7  (nama_project , file ) VALUES ('$nama_project', '$nama_file')  "; 
   ...
   $selectQuery = "SELECT * FROM tb_file7";
...
<body>
    ...
    <div class="container">
          <h2 class="mt-4">PT Kreatif Media Karya Group</h2>
            <div class="body">
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>Develop WAF (Web Application Firewall) for Implement on All Web Apps</td>
                                            <td><span class="label bg-green">1 December 2018</span></td>
                                            <td>    
