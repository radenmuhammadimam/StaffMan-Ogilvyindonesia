...
if ( isset ( $_SESSION [ 'id' ] ))
{
      ...
      */
      ...
      if(empty($errors)==true)
      {
        ...
        if(isset($_POST['nama_project']))
        {
            ...
            $insertQuery = " INSERT INTO tb_file4  (nama_project , file ) VALUES ('$nama_project', '$nama_file')  "; 
   ...
   $selectQuery = "SELECT * FROM tb_file4";
...
<body>
    ...
    <div class="container">
          <h2 class="mt-4">PT Telekomunikasi Indonesia (Persero) Tbk.</h2>
            <div class="body">
                                ...
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="label bg-green">1 August 2018</span></td>
                                            <td>    
